      ...
      <div className="relative w-full h-full flex flex-col" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-black/50 text-white">
          ...
          <div className="flex items-center gap-1">
            <Tooltip content={t('resultViewer.zoomOut')}>
            ...
            <Tooltip content={t('resultViewer.zoomIn')}>
            ...
            <Tooltip content={t('resultViewer.fitToScreen')}>
            ...
            <Tooltip content={t('resultViewer.fullscreen')}>
            ...
            <Tooltip content={t('resultViewer.download')}>
            ...
            <div className="w-px h-6 bg-white/20 mx-2" />
            <Tooltip content={t('resultViewer.close')}>
        ...
        <div className="flex-1 flex items-center justify-center overflow-auto p-8">
          <div className="relative">
            <img
              ...
              alt={`${t('resultViewer.generation')} ${currentIndex + 1}`}
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-black/50 text-white">
          ...
          <div className="flex items-center gap-2">
            {onFavorite && (
              <Tooltip content={t('resultViewer.favorite')}>
            ...
            {onImprove && (
              <Tooltip content={t('resultViewer.improve')}>
            ...
            {onVariation && (
              <Tooltip content={t('resultViewer.generateVariation')}>
